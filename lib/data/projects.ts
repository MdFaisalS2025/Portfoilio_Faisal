...
export type Project = {
  ...
  domains?: string[];
  /** Real visual evidence — a screenshot of the actual deployed or locally
    ...
    evidenceImages: [
      {
        ...
        alt: "The real 'Ask RAEY' question interface, empty state, with example questions",
        caption: "The retrieval interface, running against a 22-SOP synthetic corpus with the LLM provider set to mock/self-hosted mode — no hospital information involved.",
      ...
      },
      {
        ...
        caption: "The app's own architecture page: the six-stage pipeline (intake, retrieval, reasoning, verification, confidence gate, output) and real technology stack, with a worked example trace using synthetic data. RAEY has no public deployment yet.",
        kind: "local-demonstration",
      },
      {
    ...
    evidenceImages: [
      {
        ...
        caption: "Local run of the real repository. The World Bank figures shown ($30.7T GDP, 341.8M population, year 2025) were fetched live from the public API at capture time, not hardcoded.",
        kind: "local-demonstration",
      },
      {
        ...
        caption: "Local run of the real repository — the Chart.js views generated from the same dataset shown on the dashboard.",
        kind: "local-demonstration",
      },
      {
    ...
    evidenceImages: [
      {
        ...
        caption: "Live screenshot from the public deployment — the real question interface and the required disclaimer. A live answer isn't captured here since generating one calls the (free-tier) Gemini API, which this audit didn't trigger.",
