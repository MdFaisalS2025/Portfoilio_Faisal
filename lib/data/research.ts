...
export const researchNotes: ResearchNote[] = [
  {
    ...
    limitation:
      "The demo dataset is 10 synthetic clinical protocols, not real hospital SOPs, and the project is explicitly labeled a research prototype, not for clinical use. Moving toward real deployment would need PostgreSQL in place of SQLite, real embedding models (the current retriever is TF-IDF-based, not semantic), and hospital SSO authentication.",
    nextExperiment:
      "Partner with a hospital to ingest their actual SOPs and re-run the same three evaluations against real procedural documents, and replace TF-IDF retrieval with sentence-transformer embeddings to test whether semantic retrieval changes the precision/verifier results.",
    sourceUrl:
